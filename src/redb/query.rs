...
impl<T, U, V> Query3<T, U, V, T, U, V> {
    pub fn project<X, Y, Z>(self, projection: fn(&T, &U, &V) -> (X, Y, Z)) -> Query3<T, U, V, X, Y, Z> {
        Query3 {
            operator: self.operator,
            projection: projection
        }
...
impl Query1<i64> {
    pub fn aggregate(&self, op1: AggregationOperation, op2: AggregationOperation) -> Query2<bool, i64, bool, i64> {
...
impl Query2<u8, f32, u8, f32> {
    pub fn aggregate(&self, op1: AggregationOperation, op2: AggregationOperation) -> Query2<u8, f32, u8, f32> {
        assert!(op1 == AggregationOperation::GroupBy);
...
impl Query2<u8, NaiveDateTime, u8, u8> {
    #[inline]
    pub fn aggregate(self, op0: AggregationOperation, op1: AggregationOperation, op2: AggregationOperation) -> Query3<u8, u8, i64, u8, u8, i64> {
