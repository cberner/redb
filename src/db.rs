...
use crate::tree_store::{
    BtreeHeader, InternalTableDefinition, PAGE_SIZE, PageHint, ReadOnlyBackend, TableTree,
...
///
/// Multiple processes may open a [`ReadOnlyDatabase`], but they MUST NOT be opened concurrently
/// with a [`Database`].
///
/// # Examples
///
